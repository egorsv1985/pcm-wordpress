...
<main class="main">
    ...
    <div class="container" uk-scrollspy="target: .uk-scrollspy-class; cls: uk-animation-slide-bottom-medium; delay: 100;">
      <div class="top__left">
        ...
        <div class="uk-scrollspy-class top__left_bottom">
          <button href="#modal-center" uk-toggle class="button">Оставить заявку</button>
          <a href="tel: <?php echo $section['телефон']; ?>">
            <span><?php echo $section['телефон']; ?></span>
            <img alt="" src="http://landing.andris.beget.tech/PCM/images/icons/arrow.svg" />
          </a>
        </div>
        <?php endif; ?>
  ...
  <section class="client">
    <div class="container">
      <h2><?php echo get_field('заголовок_секции_4');?></h2>
      <ul>
        <?php
        ...
        <li>
          ...
          <p><?php the_sub_field('заголовок');?></p>
        </li>
            <? endwhile;
        else :
        endif;
  ...
  <!-- <section class="profit">
    <div class="container">
      ...
      if( $section5 ): ?>
      <h2><?php echo $section5['заголовок']; ?></h2>
      <ul>
        <li>
          <img src="http://landing.andris.beget.tech/PCM/images/profit.png" />
          <p><?php echo $section5['описание_1']; ?></p>
        </li>
        <li>
          <img src="http://landing.andris.beget.tech/PCM/images/profit.png" />
          <p><?php echo $section5['описание_2']; ?></p>
        </li>
        <li>
          <img src="http://landing.andris.beget.tech/PCM/images/profit.png" />
          <p><?php echo $section5['описание_3']; ?></p>
        </li>
        <li>
          <img src="http://landing.andris.beget.tech/PCM/images/profit.png" />
          <p><?php echo $section5['описание_4']; ?></p>
        </li>
      <?php endif; ?>
  ...
  <section class="why">
    <div class="container">
      ...
      <p>Оставьте заявку, чтобы узнать детали!</p>

      <a href="#modal-center" uk-toggle>Оставить заявку</a>
  ...
  <section class="details">
    <div class="container">
      <h2><?php echo get_field('заголовок_секции_7'); ?></h2>
      <!-- <ul>
        <?php
        if( have_rows('секция_7') ):
        while ( have_rows('секция_7') ) : the_row();?>
        <li><?php the_sub_field('заголовок');?></li>
        <? endwhile;
        else :
        endif;
        ?>
      ...
      <div class="slider uk-position-relative" tabindex="-1" uk-slider>
  ...
  <section class="office">
    <h2><?php echo get_field('заголовок_секции_8'); ?></h2>

    <div class="uk-position-relative container" tabindex="-1" uk-slider="center: true, finite: true">
      <ul class="uk-slider-items uk-grid">
        <?php
        if( have_rows('секция_8') ):
        while ( have_rows('секция_8') ) : the_row();?>
        <li class="uk-width-1-2@m link_a">
          <a  data-src="<?php the_sub_field('слайд');?>" data-fancybox="gallery" href="#">
            <img src="<?php the_sub_field('слайд');?>" />
          </a>
        </li>
        <? endwhile;
        else :
  ...
  <section class="questions">
    <div class="container">
      ...
      <ul uk-accordion>
        <?php
        if( have_rows('секция_10') ):
        while ( have_rows('секция_10') ) : the_row();?>
        <li>
          <a class="uk-accordion-title" href="#"><?php the_sub_field('заголовок');?></a>
          <div class="uk-accordion-content">
            <?php echo the_sub_field('описание');?>
          </div>
        </li>
        <? endwhile;
        else :
      ...
      <div>
        <ul>
          ...
          <li>
            ...
            <p><?php the_sub_field('заголовок_');?></p>
          </li>
          <? endwhile;
          else :
          endif;
  ...
  <section class="feedback">
    <div class="container">
      <?php
        $section13 = get_field('cекция_13');
        if( $section13 ): ?>
        <img class="feedback__left" src="<?php echo $section13['изображение']; ?>" />
        <div class="feedback__right">
          <h2><?php echo $section13['заголовок']; ?></h2>
          <p><?php echo $section13['описание']; ?></p>
        <?php endif; ?>
